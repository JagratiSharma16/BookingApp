      ...
      <div className="flex flex-col md:flex-row gap-10 items-center">
        ...
        <div className="md:w-1/2">
          <p className="text-lg mb-6 text-gray-700 text-left">
            Welcome to <span className="font-semibold text-blue-600">BoookANEvvent</span> – your one-stop platform for seamless seminar and auditorium hall booking!
          </p>
        ...
        {/* IMAGE SECTION */}
        <div className="md:w-1/2">
        <img src="https://imgs.search.brave.com/XOxDFVX1vopw6-64vpv8g5WDF54Vmx060piEiNP_Kts/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly93d3cu/c3RhdGljLWNvbnRl/bnRzLnlvdXRoNHdv/cmsuY29tL3VuaXZl/cnNpdHkvRG9jdW1l/bnRzL0NvbGxlZ2Vz/L0NvbGxlZ2VJbWFn/ZXMvOGEzYzRhOTIt/YzE0YS00ODllLTkw/MTEtZmYyN2FiNmZh/MzRlLnBuZz92PTIw/MjAwMjI3MTQ1OTM3" class="w-64 h-auto rounded-lg shadow-md" alt="Image" />
