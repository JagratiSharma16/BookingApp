...
function About() {
  return (
    <div className="bg-gradient-to-r from-orange-200 via-orange-50 to-orange-200 min-h-screen">
      <div className="p-6 sm:p-8 xl:p-12 2xl:p-4  max-w-6xl xl:max-w-7xl 2xl:max-w-screen-2xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-10 items-center xl:gap-16 2xl:gap-30">
          {/* TEXT SECTION */}
          <div className="md:w-1/2">
            <p className="text-lg xl:text-xl 2xl:text-2xl mb-6 text-gray-700 text-left leading-relaxed">
            ...
            <div className="bg-white p-6 xl:p-8 rounded-3xl shadow-xl hover:shadow-2xl transition-shadow duration-300">
              <h2 className="text-2xl xl:text-3xl 2xl:text-4xl font-semibold mb-3 text-orange-700">Our Mission</h2>
              <p className="text-gray-700 mb-4 text-base xl:text-lg 2xl:text-xl leading-relaxed">
              ...
              <h2 className="text-2xl xl:text-3xl 2xl:text-4xl font-semibold mb-3 text-orange-700">What We Offer</h2>
              <ul className="list-disc list-inside text-gray-700 space-y-2 text-base xl:text-lg 2xl:text-xl">
                {[
              ...
              <h2 className="text-2xl xl:text-3xl 2xl:text-4xl font-semibold mt-6 mb-3 text-orange-700">Why Choose Us?</h2>
          ...
          <div className="md:w-1/2 flex justify-center">
            <img
              src={assets.aboutimg}
              alt="Event Hall"
              className="w-64 sm:w-72 md:w-80 lg:w-[22rem] xl:w-[26rem] 2xl:w-[50rem] h-auto rounded-2xl shadow-2xl transform hover:scale-105 transition-transform duration-300 ease-in-out"
            />
          </div>
        </div>
        ...
        <div className="mt-16 bg-gradient-to-br from-gray-100 to-white p-6 xl:p-10 rounded-3xl shadow-md hover:shadow-xl transition-shadow duration-300">
          <h2 className="text-2xl xl:text-3xl 2xl:text-4xl font-semibold text-orange-800 mb-4">Contact Us</h2>
          <div className="text-gray-700 text-base xl:text-lg 2xl:text-xl leading-relaxed space-y-2">
            <p>
