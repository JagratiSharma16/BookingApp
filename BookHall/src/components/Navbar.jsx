...
const Navbar = () => {
    ...
    return (
        <div>
            <div>
                <div className="flex items-center justify-between text-5m py-5 mb-5 border-b-3 border-b-gray-400 2xl:ml-30 2xl:mr-30 xl:ml-20 xl:mr-20 mx-10 shadow-lg">
                    <img onClick={() => navigate("/")} className="w-26 rounded-2xl cursor-pointer" src={assets.Booklogo} alt="image" />
